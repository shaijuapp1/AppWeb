...
namespace API.Controllers
{
    ...
    {
        [HttpPost]
        public async Task<IActionResult> AddData(int TableId, string DataJson)
        {
            return HandleResult(await Mediator.Send(new AddData.Command { TableId = TableId, DataJson = DataJson }));
        }
